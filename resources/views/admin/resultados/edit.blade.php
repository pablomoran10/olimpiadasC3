            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('resultados.update', ['resultado' => $resultado]) }}" method="POST" enctype="multipart/form-data">
                        ...
                        @method('PUT')
                        <div class="mb-4">
                            <label for="id" class="block text-gray-700">ID de la Edición</label>
                            <input type="text" name="id" id="id" value="{{ old('id') ?? $resultado->id }}" class="w-full border-gray-300 rounded-md">
                        </div>
                        <div class="mb-4">
