...
<html>
	...
	<body class="is-preload">
		...
		<!-- Header -->
			<section id="header">
				<header>
					<span class="image logo"><img src="{{ asset('/readonly/images/logoC3.png') }}" alt="" /></span>
					<h1 id="logo"><a href="#">Olimpiadas</a></h1>
					<h1>Informáticas Región<br />
					de Murcia</h1>
				</header>
				<nav id="nav">
					<ul>
						...
						<!-- One -->
							<section id="one">
								<div class="image main" data-position="center">
									<img src="{{ asset('/readonly/images/avengers.png') }}" alt="" />
								</div>
								<div class="container">
									<header class="major">
										<h2>Objetivos</h2>
									...
									<p>Las Olimpiada Informáticas de la Región de Murcia para los Institutos de Educación Secundaria y
                                        Centros Integrados de Formación Profesional tiene como objetivos:
                                        • el fomento del trabajo en equipo, propiciando que los alumnos focalicen sus esfuerzos en conseguir
                                        ...
                                        tienen como �nalidad la preparación de los alumnos para la actividad en este campo profesional. La
                                        Formación Profesional proporciona a sus alumnos un aprendizaje polivalente, que les permite
                                        adaptarse a las modi�caciones laborales que pueden producirse a lo largo de su vida. </p>
								</div>
							</section>
